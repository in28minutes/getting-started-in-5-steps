...
Learn to install Java 9

### Prerequisites
- If Windows > You need to have 64 - Bit OS
...
5. Choose the Java Install for your Operating System.
...
### Troubleshooting
1. If you are on Windows : Check the PATH variable.

add the full path of the jdk-9\bin directory to the PATH variable.
Control Panel and then System.
Advanced and then Environment Variables
